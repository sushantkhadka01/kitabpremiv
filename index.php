...
<body>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            <?php
            $select_book = mysqli_query($conn, "SELECT * FROM `book_info` where category='Technology'") or die('query failed');
            if (mysqli_num_rows($select_book) > 0) {
                while ($fetch_book = mysqli_fetch_assoc($select_book)) {
                    ?>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            <?php
            $select_book = mysqli_query($conn, "SELECT * FROM `book_info` where category='Manga'") or die('query failed');
            if (mysqli_num_rows($select_book) > 0) {
                while ($fetch_book = mysqli_fetch_assoc($select_book)) {
                    ?>
