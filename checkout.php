...
<body>
  ...
  <p style="text-align: center; ">*First Pay, and place order for delivery after successful payment</p>
  <div class="row">
    <div class="col-75">
      <div class="container">
  ...
  <script
    src="https://www.paypal.com/sdk/js?client-id=Ae2FcWcqSZuODjw8ZP5vhYOgKTwZtR2nHnu6Ad2V-bYqOlguVTthY_iA8a-lMDho2T-aCucu0aRY6S1n&currency=USD&disable-funding=credit,card"></script>
  <script>
    paypal.Buttons({
      ...
      onApprove(data,actions) {
        return actions.order.capture().then(function(details){
          console.log(details)
          window.location.replace("http://localhost/kitabpremi/success.php")
        })  
      },
      onCancel(data) {
          window.location.replace("http://localhost/kitabpremi/failure.php")
      }
